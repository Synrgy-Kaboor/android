...
interface AuthRepository {
    ...
    suspend fun resendOTP(body: EmailRequest): Flow<Resource<ResponseWrapper<UserResponse>>>
    ...
    suspend fun verifyOtpResetPassword(body: EmailRequest): Flow<Resource<KaboorGenericResponse>>
